"""
OCR English Service
Extracts text from images using Tesseract OCR for English language
"""
import logging
...
app = FastAPI(title="OCR English Service", version="1.0.0")
...
def health_check():
    ...
    return {"status": "ok", "service": "ocr-en"}
...
async def extract_text(file: UploadFile = File(...)):
    ...
    try:
        ...
        return OCRResponse(
            success=True,
            text="[Mock OCR Text] This is a placeholder text extracted from the image.",
            confidence=0.95,
            language="eng",
    ...
    try:
        ...
        for idx, file in enumerate(files):
            ...
            results.append({
                ...
                "text": f"[Mock OCR Text {idx}] Placeholder text.",
                "confidence": 0.95,
                "page": idx
            })
